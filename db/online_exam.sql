...
INSERT INTO `biz_article_look` VALUES (4, 1, NULL, '0:0:0:0:0:0:0:1', '2019-01-13 17:33:12', '2019-01-13 17:33:12', '2019-01-13 17:33:12');
...
-- ----------------------------
INSERT INTO `biz_category` VALUES (1, 0, 'C/C++程序设计', '主要收集、整理的基础前端类文章，包括JS、jQuery和CSS等Web开发所需的基础的文章总结', 1, 'fa fa-css3', 1, '2018-01-14 21:34:54', '2019-01-13 17:12:25');
INSERT INTO `biz_category` VALUES (2, 0, 'Java程序设计', '网站中记录的后端类文章，包括Java、SSM、MySQL和其他在日常工作学习中所用的后端技术', 2, 'fa fa-coffee', 1, '2018-01-14 21:34:57', '2019-01-13 17:12:51');
INSERT INTO `biz_category` VALUES (3, 0, '计算机组成原理', '计算机组成原理', 4, 'fa fa-folder-open-o', 1, '2018-01-20 22:28:03', '2019-01-13 17:14:00');
INSERT INTO `biz_category` VALUES (4, 0, '数据结构与算法分析', '数据结构与算法分析', 3, NULL, 1, '2018-08-02 11:20:26', '2019-01-13 17:13:42');
...
INSERT INTO `permission` VALUES (52, '1000000602555213', '考试管理', '考试管理', NULL, NULL, 0, 0, 2, 'fa fa-th-list', 1, '2018-07-25 17:43:12', '2019-01-12 23:58:01');
INSERT INTO `permission` VALUES (53, '1000001729104792', '课目管理', '课目管理', '/categories', 'categories', 52, 1, 3, 'fa fa-circle-o', 1, '2018-07-25 17:43:50', '2019-01-13 17:11:27');
...
INSERT INTO `permission` VALUES (65, '1000001038456544', '试题管理', '试题管理', '/articles', 'articles', 52, 1, 2, 'fa fa-circle-o', 1, '2018-07-29 20:20:23', '2019-01-12 23:59:49');
...
INSERT INTO `permission` VALUES (71, '1000000899091444', '发布考试', '发布考试', '/article/add', 'article:add', 52, 1, 1, 'fa fa-circle-o', 1, '2018-07-29 20:39:49', '2019-01-12 23:57:49');
...
CREATE TABLE `role_permission`  (
  ...
  `permission_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1918 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '1', 'admin', '872359cc44c637cc73b7cd55c06d95e4', '8cd50474d2a3c1e88298e91df8bf6f1c', '超级管理员', '888@qq.com', '18788889999', 1, 22, 'http://cdn.nbclass.com/blog/img/person.jpg', 1, '2018-05-23 21:22:06', '2018-07-17 23:04:46', '2019-01-16 22:26:24');
